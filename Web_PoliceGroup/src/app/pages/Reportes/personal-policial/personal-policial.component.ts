...
export class PersonalPolicialComponent implements OnInit {
 ...
 mostrarInformacion(){
      ...
      this.spinner.show();
      this.personalService.get_mostrarPersonalPolicia_general(this.formParamsFiltro.value.idEmpresa )
