...
namespace Datos
{
    ...
    public partial class policegroupEntities : DbContext
    {
        public policegroupEntities()
            : base("name=policegroupEntities")
        {
        }
        ...
        public virtual DbSet<tbl_Usuarios_Empresa> tbl_Usuarios_Empresa { get; set; }
        public virtual DbSet<tbl_Personal> tbl_Personal { get; set; }
        public virtual DbSet<tbl_Personal_Empresa> tbl_Personal_Empresa { get; set; }
        public virtual DbSet<tbl_Documento_Policial> tbl_Documento_Policial { get; set; }
        public virtual DbSet<tbl_Personal_Documento> tbl_Personal_Documento { get; set; }
        public virtual DbSet<tbl_Ibp_Cab> tbl_Ibp_Cab { get; set; }
        public virtual DbSet<tbl_Ibp_Det> tbl_Ibp_Det { get; set; }
    }
}
